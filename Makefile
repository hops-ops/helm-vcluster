...
PACKAGE ?= helm-vcluster
XRD_DIR := apis/vclusters
COMPOSITION := $(XRD_DIR)/composition.yaml
DEFINITION := $(XRD_DIR)/definition.yaml
EXAMPLE_DEFAULT := examples/vclusters/standard.yaml
...
EXAMPLES := \
    examples/vclusters/minimal.yaml:: \
    examples/vclusters/standard.yaml::
...
render\:%:
	@example="examples/vclusters/$*.yaml"; \
	up composition render --xrd=$(DEFINITION) $(COMPOSITION) $$example
